...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      surface: Color(0xFF56D5FB), // Aquí el fondo celeste
      onSurface: Color(0xFF003344), // Color oscuro para textos sobre el fondo
      background: Color(0xFF56D5FB), // Mismo color de fondo para toda la app
      onBackground: Color(0xFF003344), // Texto sobre fondo
      // Resto de colores igual o ajusta para mejorar contraste
      outline: Color(0xFF003344), // Contornos con contraste
      shadow: Color(0xFF000000),
      scrim: Color(0xFF000000),
      inverseSurface: Color(0xFF003344),
